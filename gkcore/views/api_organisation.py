...
class api_organisation(object):
	...
	def gkUpgrade(self):
		...
		try:
			...
			self.con.execute("insert into state( statecode, statename)values(1, 'Jammu & Kashmir')")
			...
			self.con.execute("insert into state( statecode, statename)values(25, 'Daman & Diu')")
			self.con.execute("insert into state( statecode, statename)values(26, 'Dadra & Nagar Haveli')")
			...
			self.con.execute("insert into state( statecode, statename)values(35, 'Andaman & Nicobar Islands')")
