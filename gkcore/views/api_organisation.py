...
class api_organisation(object):
    ...
    def gkUpgrade(self):
        ...
        try:
            ...
            #In Below query we are adding field othcharges to invoice table
            if not columnExists("invoice","othcharges"):
                self.con.execute("alter table invoice add othcharges json")
            #In Below query we are adding field othcharges to invoicebin table
            if not columnExists("invoicebin","othcharges"):
                self.con.execute("alter table invoicebin add othcharges json")
