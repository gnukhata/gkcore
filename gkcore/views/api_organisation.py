        ...
        try:
            ...
            if not columnExists("unitofmeasurement","description"):
                ...
                for uom in listofuqc:
                    ...
                    if uqcname == None:
                        if uom == 'BAG':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BAG',0.00,'BAG',1)")
                        elif uom == 'BGS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BGS',0.00,'BAGS',1)")
                        elif uom == 'BLS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BLS',0.00,'BAILS',1)")
                        elif uom == 'BTL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BTL',0.00,'BOTTLES',1)")
                        elif uom == 'BOU':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BOU',0.00,'BOU',1)")
                        elif uom == 'BOX':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BOX',0.00,'BOXES',1)")
                        elif uom == 'BKL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BKL',0.00,'BUCKLES',1)")
                        elif uom == 'BLK':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BLK',0.00,'BULK',1)")
                        elif uom == 'BUN':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BUN',0.00,'BUNCHES',1)")
                        elif uom == 'BDL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BDL',0.00,'BUNDLES',1)")
                        elif uom == 'CAN':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CAN',0.00,'CANS',1)")
                        elif uom == 'CTN':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CTN',0.00,'CARTONS',1)")
                        elif uom == 'CAS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CAS',0.00,'CASES',1)")
                        elif uom == 'CMS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CMS',0.00,'CENTIMETER',1)")
                        elif uom == 'CHI':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CHI',0.00,'CHEST',1)")
                        elif uom == 'CLS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CLS',0.00,'COILS',1)")
                        elif uom == 'COL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('COL',0.00,'COLLIES',1)")
                        elif uom == 'CRI':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CRI',0.00,'CRATES',1)")
                        elif uom == 'CCM':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CCM',0.00,'CUBIC CENTIMETER',1)")
                        elif uom == 'CIN':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CIN',0.00,'CUBIC INCHES',1)")
                        elif uom == 'CBM':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CBM',0.00,'CUBIC METER',1)")
                        elif uom == 'CQM':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CQM',0.00,'CUBIC METERS',1)")
                        elif uom == 'CYL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CYL',0.00,'CYLINDER',1)")
                        elif uom == 'SDM':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SDM',0.00,'DECAMETER SQUARE',1)")
                        elif uom == 'DAY':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('DAY',0.00,'DAYS',1)")
                        elif uom == 'DOZ':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('DOZ',0.00,'DOZEN',1)")
                        elif uom == 'DRM':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('DRM',0.00,'DRUMS',1)")
                        elif uom == 'FTS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('FTS',0.00,'FEET',1)")
                        elif uom == 'FLK':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('FLK',0.00,'FLASKS',1)")
                        elif uom == 'GMS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('GMS',0.00,'GRAMS',1)")
                        elif uom == 'TON':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('TON',0.00,'GREAT BRITAIN TON',1)")
                        elif uom == 'GGR':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('GGR',0.00,'GREAT GROSS',1)")
                        elif uom == 'GRS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('GRS',0.00,'GROSS',1)")
                        elif uom == 'GYD':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('GYD',0.00,'GROSS YARDS',1)")
                        elif uom == 'HBK':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('HBK',0.00,'HABBUCK',1)")
                        elif uom == 'HKS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('HKS',0.00,'HANKS',1)")
                        elif uom == 'HRS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('HRS',0.00,'HOURS',1)")
                        elif uom == 'INC':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('INC',0.00,'INCHES',1)")
                        elif uom == 'JTA':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('JTA',0.00,'JOTTA',1)")
                        elif uom == 'JTA':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('KGS',0.00,'KILOGRAMS',1)")
                        elif uom == 'KLR':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('KLR',0.00,'KILOLITER',1)")
                        elif uom == 'KME':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('KME',0.00,'KILOMETERS',1)")
                        elif uom == 'LTR':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('LTR',0.00,'LITERS',1)")
                        elif uom == 'LOG':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('LOG',0.00,'LOGS',1)")
                        elif uom == 'LOT':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('LOT',0.00,'LOTS',1)")
                        elif uom == 'MTR':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('MTR',0.00,'METER',1)")
                        elif uom == 'MTS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('MTS',0.00,'METRIC TON',1)")
                        elif uom == 'MGS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('MGS',0.00,'MILLIGRAMS',1)")
                        elif uom == 'MLT':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('MLT',0.00,'MILLILITER',1)")
                        elif uom == 'MMT':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('MMT',0.00,'MILLIMETER',1)")
                        elif uom == 'NONE':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('NONE',0.00,'NOT CHOSEN',1)")
                        elif uom == 'NOS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('NOS',0.00,'NUMBERS',1)")
                        elif uom == 'ODD':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('ODD',0.00,'ODDS',1)")
                        elif uom == 'PAC':    
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('PAC',0.00,'PACKS',1)")
                        elif uom == 'PAI':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('PAI',0.00,'PAILS',1)")
                        elif uom == 'PRS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('PRS',0.00,'PAIRS',1)")
                        elif uom == 'PLT':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('PLT',0.00,'PALLETS',1)")
                        elif uom == 'PCS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('PCS',0.00,'PIECES',1)")
                        elif uom == 'LBS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('LBS',0.00,'POUNDS',1)")
                        elif uom == 'QTL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('QTL',0.00,'QUINTAL',1)")
                        elif uom == 'REL': 
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('REL',0.00,'REELS',1)")
                        elif uom == 'ROL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('ROL',0.00,'ROLLS',1)")
                        elif uom == 'SET':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SET',0.00,'SETS',1)")
                        elif uom == 'SHT':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SHT',0.00,'SHEETS',1)")
                        elif uom == 'SLB':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SLB',0.00,'SLABS',1)")
                        elif uom == 'SQF':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SQF',0.00,'SQUARE FEET',1)")
                        elif uom == 'SQI':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SQI',0.00,'SQUARE INCHES',1)")
                        elif uom == 'SQC':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SQC',0.00,'SQUARE CENTIMETERS',1)")
                        elif uom == 'SQM':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SQM',0.00,'SQUARE METER',1)")
                        elif uom == 'SQY':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('SQY',0.00,'SQUARE YARDS',1)")
                        elif uom == 'BLO':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('BLO',0.00,'STEEL BLOCKS',1)")
                        elif uom == 'TBL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('TBL',0.00,'TABLES',1)")
                        elif uom == 'TBS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('TBS',0.00,'TABLETS',1)")
                        elif uom == 'TGM':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('TGM',0.00,'TEN GROSS',1)")
                        elif uom == 'THD':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('THD',0.00,'THOUSANDS',1)")
                        elif uom == 'TIN':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('TIN',0.00,'TINS',1)")
                        elif uom == 'TOL':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('TOL',0.00,'TOLA',1)")
                        elif uom == 'TRK':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('TRK',0.00,'TRUNK',1)")
                        elif uom == 'TUB':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('TUB',0.00,'TUBES',1)")
                        elif uom == 'UNT':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('UNT',0.00,'UNITS',1)")
                        elif uom == 'UGS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('UGS',0.00,'US GALLONS',1)")
                        elif uom == 'VLS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('VLS',0.00,'VIALS',1)")
                        elif uom == 'CSK':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('CSK',0.00,'WOODEN CASES',1)")
                        elif uom == 'YDS':
                            self.con.execute("insert into unitofmeasurement(unitname, conversionrate, description, sysunit)values('YDS',0.00,'YARDS',1)")
                    else:
                        if uqcname['unitname'] == 'BAG':
                            self.con.execute("update unitofmeasurement set description = 'BAG', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BGS':
                            self.con.execute("update unitofmeasurement set description = 'BAGS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BLS':
                            self.con.execute("update unitofmeasurement set description = 'BAILS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BTL':
                            self.con.execute("update unitofmeasurement set description = 'BOTTLES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BOU':
                            self.con.execute("update unitofmeasurement set description = 'BOU', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BOX':
                            self.con.execute("update unitofmeasurement set description = 'BOXES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BKL':
                            self.con.execute("update unitofmeasurement set description = 'BUCKLES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BLK':
                            self.con.execute("update unitofmeasurement set description = 'BULK', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BUN':
                            self.con.execute("update unitofmeasurement set description = 'BUNCHES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BDL':
                            self.con.execute("update unitofmeasurement set description = 'BUNDLES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CAN':
                            self.con.execute("update unitofmeasurement set description = 'CANS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CTN':
                            self.con.execute("update unitofmeasurement set description = 'CARTONS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CAS':
                            self.con.execute("update unitofmeasurement set description = 'CASES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CMS':
                            self.con.execute("update unitofmeasurement set description = 'CENTIMETER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CHI':
                            self.con.execute("update unitofmeasurement set description = 'CHEST', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CLS':
                            self.con.execute("update unitofmeasurement set description = 'COILS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'COL':
                            self.con.execute("update unitofmeasurement set description = 'COLLIES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CRI':
                            self.con.execute("update unitofmeasurement set description = 'CRATES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CCM':
                            self.con.execute("update unitofmeasurement set description = 'CUBIC CENTIMETER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CIN':
                            self.con.execute("update unitofmeasurement set description = 'CUBIC INCHES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CBM':
                            self.con.execute("update unitofmeasurement set description = 'CUBIC METER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CQM':
                            self.con.execute("update unitofmeasurement set description = 'CUBIC METERS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CYL':
                            self.con.execute("update unitofmeasurement set description = 'CYLINDER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SDM':
                            self.con.execute("update unitofmeasurement set description = 'DECAMETER SQUARE', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'DAY':
                            self.con.execute("update unitofmeasurement set description = 'DAYS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'DOZ':
                            self.con.execute("update unitofmeasurement set description = 'DOZEN', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'DRM':
                            self.con.execute("update unitofmeasurement set description = 'DRUMS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'FTS':
                            self.con.execute("update unitofmeasurement set description = 'FEET', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'FLK':
                            self.con.execute("update unitofmeasurement set description = 'FLASKS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'GMS':
                            self.con.execute("update unitofmeasurement set description = 'GRAMS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'TON':
                            self.con.execute("update unitofmeasurement set description = 'GREAT BRITAIN TON', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'GGR':
                            self.con.execute("update unitofmeasurement set description = 'GREAT GROSS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'GRS':
                            self.con.execute("update unitofmeasurement set description = 'GROSS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'GYD':
                            self.con.execute("update unitofmeasurement set description = 'GROSS YARDS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'HBK':
                            self.con.execute("update unitofmeasurement set description = 'HABBUCK', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'HKS':
                            self.con.execute("update unitofmeasurement set description = 'HANKS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'HRS':
                            self.con.execute("update unitofmeasurement set description = 'HOURS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'INC':
                            self.con.execute("update unitofmeasurement set description = 'INCHES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'JTA':
                            self.con.execute("update unitofmeasurement set description = 'JOTTA', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'KGS':
                            self.con.execute("update unitofmeasurement set description = 'KILOGRAMS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'KLR':
                            self.con.execute("update unitofmeasurement set description = 'KILOLITER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'KME':
                            self.con.execute("update unitofmeasurement set description = 'KILOMETERS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'LTR':
                            self.con.execute("update unitofmeasurement set description = 'LITERS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'LOG':
                            self.con.execute("update unitofmeasurement set description = 'LOGS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'LOT':
                            self.con.execute("update unitofmeasurement set description = 'LOTS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'MTR':
                            self.con.execute("update unitofmeasurement set description = 'METER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'MTS':
                            self.con.execute("update unitofmeasurement set description = 'METRIC TON', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'MGS':
                            self.con.execute("update unitofmeasurement set description = 'MILLIGRAMS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'MLT':
                            self.con.execute("update unitofmeasurement set description = 'MILLILITER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'MMT':
                            self.con.execute("update unitofmeasurement set description = 'MILLIMETER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'NONE':
                            self.con.execute("update unitofmeasurement set description = 'NOT CHOSEN', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'NOS':
                            self.con.execute("update unitofmeasurement set description = 'NUMBERS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'ODD':
                            self.con.execute("update unitofmeasurement set description = 'ODDS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'PAC':
                            self.con.execute("update unitofmeasurement set description = 'PACKS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'PAI':
                            self.con.execute("update unitofmeasurement set description = 'PAILS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'PRS':
                            self.con.execute("update unitofmeasurement set description = 'PAIRS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'PLT':
                            self.con.execute("update unitofmeasurement set description = 'PALLETS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'PCS':
                            self.con.execute("update unitofmeasurement set description = 'PIECES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'LBS':
                            self.con.execute("update unitofmeasurement set description = 'POUNDS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'QTL':
                            self.con.execute("update unitofmeasurement set description = 'QUINTAL', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'REL':
                            self.con.execute("update unitofmeasurement set description = 'REELS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'ROL':
                            self.con.execute("update unitofmeasurement set description = 'ROLLS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SET':
                            self.con.execute("update unitofmeasurement set description = 'SETS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SHT':
                            self.con.execute("update unitofmeasurement set description = 'SHEETS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SLB':
                            self.con.execute("update unitofmeasurement set description = 'SLABS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SQF':
                            self.con.execute("update unitofmeasurement set description = 'SQUARE FEET', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SQI':
                            self.con.execute("update unitofmeasurement set description = 'SQUARE INCHES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SQC':
                            self.con.execute("update unitofmeasurement set description = 'SQUARE CENTIMETERS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SQM':
                            self.con.execute("update unitofmeasurement set description = 'SQUARE METER', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'SQY':
                            self.con.execute("update unitofmeasurement set description = 'SQUARE YARDS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'BLO':
                            self.con.execute("update unitofmeasurement set description = 'STEEL BLOCKS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'TBL':
                            self.con.execute("update unitofmeasurement set description = 'TABLES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'TBS':
                            self.con.execute("update unitofmeasurement set description = 'TABLETS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'TGM':
                            self.con.execute("update unitofmeasurement set description = 'TEN GROSS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'THD':
                            self.con.execute("update unitofmeasurement set description = 'THOUSANDS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'TIN':
                            self.con.execute("update unitofmeasurement set description = 'TINS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'TOL':
                            self.con.execute("update unitofmeasurement set description = 'TOLA', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'TRK':
                            self.con.execute("update unitofmeasurement set description = 'TRUNK', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'TUB':
                            self.con.execute("update unitofmeasurement set description = 'TUBES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'UNT':
                            self.con.execute("update unitofmeasurement set description = 'UNITS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'UGS':
                            self.con.execute("update unitofmeasurement set description = 'US GALLONS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'VLS':
                            self.con.execute("update unitofmeasurement set description = 'VIALS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'CSK':
                            self.con.execute("update unitofmeasurement set description = 'WOODEN CASES', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
                        elif uqcname['unitname'] == 'YDS':
                            self.con.execute("update unitofmeasurement set description = 'YARDS', sysunit = 1 where uomid=%d"%int(uqcname['uomid']))
