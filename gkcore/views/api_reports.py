                   ...
                   # try:
                       ...
                       # print invoicedata
                        ...
                        for pc in row["contents"].iterkeys():
                            print "now we are in inner most loop"
                            discamt = 0.00
                           ...
                           # print taxrate
                            if taxdata.has_key(str(taxrate)) and taxrate != "0.00":
                            ...
                            if taxrate not in taxcolumns and taxrate != "0.00":
