...
invoice = Table('invoice',metadata,
	...
	Column('orderno', UnicodeText,ForeignKey('purchaseorder.orderid')),
	Column('orgcode',Integer, ForeignKey('organisation.orgcode',ondelete="CASCADE"), nullable=False),
	Column('custid',Integer, ForeignKey('customerandsupplier.custid',ondelete="CASCADE")),
	Column('orderno',UnicodeText, ForeignKey('purchaseorder.orderid',ondelete="CASCADE")),
