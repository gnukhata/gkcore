...
class TestCustomer:
	...
	def setup(self):
		custdata = {"custname":"rahul_mahi","custaddr":"goregaon","custphone":"432123","custemail":"rahulkande@gmail.com","custfax":"FAX212345","state":"Maharashtra","custpan":"IDPAN1234","custtan":"IDTAN1234","csflag":3}
	...
	def test_create_customer(self):
		custdata = {"custname":"sunil tamate","custaddr":"borivali, mumbai west","custphone":"432156","custemail":"suniltamate@gmail.com","custfax":"FAX334433","state":"Maharashtra","custpan":"IDPAN1235","custtan":"IDTAN1235","csflag":3}
		result = requests.post("http://127.0.0.1:6543/customersupplier", data =json.dumps(custdata),headers=self.header)
	...
	def test_update_customer(self):
		custdata = {"custname":"rahul mande","custaddr":"goregaon, mumbai west","custphone":"023524","custemail":"rahulmande@gmail.com","custfax":"FAX212345","state":"Maharashtra","custpan":"IDPAN1234","custtan":"IDTAN1234","csflag":3, "custid": int(self.democustid)}
